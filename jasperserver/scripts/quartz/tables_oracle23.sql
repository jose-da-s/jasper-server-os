-- ============================================================================
-- Oracle 23c BOOLEAN Support & Quartz Scheduler Compatibility
--
-- Oracle 23c introduces native BOOLEAN support in SQL, allowing columns like:
--     IS_DURABLE BOOLEAN NOT NULL
-- Quartz Scheduler:
-- Columns like IS_DURABLE, IS_NONCONCURRENT, etc., represent boolean flags.
-- Older Quartz versions used VARCHAR(1), but recent versions support BOOLEAN
-- when Oracle 23c is detected.
-- ============================================================================
